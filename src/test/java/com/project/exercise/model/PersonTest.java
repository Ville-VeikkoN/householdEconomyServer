...
class PersonTest {
	...
	public void testInvalidPerson() {
		...
		IllegalArgumentException setInvalidNameEx = assertThrows(IllegalArgumentException.class,
				() -> adult.setFirstName("Georg3"), "Expected IllegalArgumentException");
		assertTrue(setInvalidNameEx.getMessage().contains("First name"));
